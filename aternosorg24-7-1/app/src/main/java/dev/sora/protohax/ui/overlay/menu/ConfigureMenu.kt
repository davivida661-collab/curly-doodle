    ...
    private fun Content(navController: NavHostController, navGraph: NavGraph, scrollState: ScrollState) {
        Card(
            ...
            Row {
                val categories = CheatCategory.values()
                val icons = mapOf(
                    CheatCategory.COMBAT to painterResource(id = R.drawable.mdi_swords),
                    CheatCategory.MOVEMENT to painterResource(id = R.drawable.mdi_sprint),
                    CheatCategory.VISUAL to painterResource(id = R.drawable.mdi_view_in_ar),
                    CheatCategory.MISC to painterResource(id = R.drawable.mdi_list_alt)
                )
