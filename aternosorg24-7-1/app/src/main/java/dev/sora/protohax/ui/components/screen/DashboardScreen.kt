...
import dev.sora.protohax.ui.components.CardNetworkStats
import dev.sora.protohax.ui.components.CardStatusIndicator
...
fun DashboardScreen(
    ...
    PHaxAppBar(
        ...
        Column(
            ...
            CardStatusIndicator(connectionState)
            AnimatedVisibility(
                visible = connectionState.value,
...
private fun BottomFloatingActionButton(
    ...
    val connectionColor by animateColorAsState(
        targetValue = if (connectionState.value) MaterialTheme.colorScheme.tertiaryContainer else MaterialTheme.colorScheme.primaryContainer,
        animationSpec = tween(500)
    )
    val contentColor by animateColorAsState(
        targetValue = if (connectionState.value) MaterialTheme.colorScheme.onTertiaryContainer else MaterialTheme.colorScheme.onPrimaryContainer,
        animationSpec = tween(500)
    )
